...
my $EXPECTED_EXAMRESULTS_REF = {
      answeredQ  => {
                      "testingFiles/exam1/student_0correct_horrible.txt"                 => 3,
                      "testingFiles/exam1/student_0correct_horrible_cheater.txt"         => 3,
                      "testingFiles/exam1/student_0correct_lazy_no_checks.txt"           => 0,
                      "testingFiles/exam1/student_1correct_because_deleter.txt"          => 3,
                      "testingFiles/exam1/student_1correct_deleted2sections.txt"         => 1,
                      "testingFiles/exam1/student_1correct_swaped_questions.txt"         => 3,
                      "testingFiles/exam1/student_2correct.txt"                          => 3,
                      "testingFiles/exam1/student_1correct_because_question_deleter.txt" => 2,
                      "testingFiles/exam1/student_3correct_excellent.txt"                => 3,
                      "testingFiles/exam1/student_3correct_good_but_edited_answers.txt"  => 3,
                      "testingFiles/exam1/student_3correct_perfect.txt"                  => 3,
                      "testingFiles/exam1/student_3correct_swaped_sections.txt"          => 3,
                      "total"                                                        => 30,
                    },
      correctAns => {
                      "testingFiles/exam1/student_0correct_horrible.txt"                 => 0,
                      "testingFiles/exam1/student_0correct_horrible_cheater.txt"         => 0,
                      "testingFiles/exam1/student_0correct_lazy_no_checks.txt"           => 0,
                      "testingFiles/exam1/student_1correct_because_deleter.txt"          => 1,
                      "testingFiles/exam1/student_1correct_deleted2sections.txt"         => 1,
                      "testingFiles/exam1/student_1correct_swaped_questions.txt"         => 1,
                      "testingFiles/exam1/student_2correct.txt"                          => 2,
                      "testingFiles/exam1/student_1correct_because_question_deleter.txt" => 1,
                      "testingFiles/exam1/student_3correct_excellent.txt"                => 3,
                      "testingFiles/exam1/student_3correct_good_but_edited_answers.txt"  => 3,
                      "testingFiles/exam1/student_3correct_perfect.txt"                  => 3,
                      "testingFiles/exam1/student_3correct_swaped_sections.txt"          => 3,
      ...
      missedEl   => {
                      "testingFiles/exam1/student_0correct_horrible_cheater.txt"         => ["Section 2 - Missing answer \t\t: Dr Damian Conway\n"],
                      "testingFiles/exam1/student_1correct_because_deleter.txt"          => [
...
my $EXPECTED_WRONG_ANSWERED_Q_REF = {
      ...
      "testingFiles/exam1/student_2correct.txt"                  => { 3 => ["To delete the correct answer"] }
};
